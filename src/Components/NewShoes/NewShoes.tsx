            ...
            <div className="container-new-shoes">
                ...
                <div className="container-cards-new-shoes">
                    ...
                    <div className="cards-new-shoes">
                        <img src="Imgs/img-1-new-shoes.jpg" className='img-new-shoes-card' />
                        <p className="title-product-card-new-shoes">سویشرت نایک مدل AO-14</p>
                    ...
                    <div className="cards-new-shoes">
                        <img src="Imgs/img-2-new-shoes.png" className='img-new-shoes-card' />
                        <p className="title-product-card-new-shoes">ست نایک مدل S-2000</p>
                    ...
                    <div className="cards-new-shoes hider-new-shoes">
                        <img src="Imgs/img-3-new-shoes.png" className='img-new-shoes-card' />
