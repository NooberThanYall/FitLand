    ...
    return (
        <div className='container'>
            <div className='container-bottom-menu'>
                ...
                <Link className="btn-icons" to={'/Cart'}><CiShoppingBasket className={`icons-bottom-menu ${location.pathname === '/Cart' ? 'icons-bottom-menu-slected' : ''} ${location.pathname === '/GetAddress' ? 'icons-bottom-menu-slected' : ''} ${location.pathname === '/Payment' ? 'icons-bottom-menu-slected' : ''}`} size={30} /></Link>
